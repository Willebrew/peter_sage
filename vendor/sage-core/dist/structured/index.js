...
__export(structured_exports, {
  createStructuredOutputGenerator: () => createStructuredOutputGenerator,
  extractJson: () => extractJson,
  generateStructuredOutput: () => generateStructuredOutput,
  generateStructuredOutputResponses: () => generateStructuredOutputResponses,
  ...
  wrapForOpenAI: () => wrapForOpenAI,
  zodToJsonSchema: () => zodToJsonSchema
});
module.exports = __toCommonJS(structured_exports);
